...
wp_enqueue_style( 'wxr-importer-app', plugins_url( 'assets/app.css', dirname( __FILE__ ) ), array(), '2.1.5' );
wp_enqueue_script( 'wxr-importer-app', plugins_url( 'assets/app.js', dirname( __FILE__ ) ), array(), '2.1.5', true );
